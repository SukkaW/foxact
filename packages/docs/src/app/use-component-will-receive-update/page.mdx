...
If you really need to directly modify other components' states (E.g. when working with third-party librari../../components/SDKs where you don't have control of that code), use `flushSync` to separate two state updates:
