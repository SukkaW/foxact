...
import TotalExportsSize from '../components/total-exports-size';
...
The entire **foxact** library has very few dependencies and is **<TotalExportsSize /> gzipped in sum**, ensuring a lean and efficient solution. And what's more...
