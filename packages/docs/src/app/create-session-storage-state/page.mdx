...
export const [useSidebarActive, useSidebarActiveValue, useSetSidebarActive] = createSessionStorageState(
...
And now you can use these hooks anywhere in your app:

```tsx filename="s../../components/sidebar.tsx" copy
import { memo } from 'react';
import { useSetSidebarActive, useSidebarActive, useSidebarActiveValue } from '../context/sidebar-active';
...
function Sidebar() {
  ...
  // If you only need the setter, you can use useSetSidebarActive instead:
